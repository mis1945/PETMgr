...
Option Explicit
Private Const pxeMODULENAME = "frmSports"""
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Sports", "sSportsID", False, oApp.Connection)) Then Exit Sub
