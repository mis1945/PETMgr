...
Begin VB.Form frmUndertime 
   BorderStyle     =   0  'None
   Caption         =   "Undertime Excuse"
   ClientHeight    =   4365
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8280
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmUndertime.frx":1DE8
   End
End
Attribute VB_Name = "frmUndertime"
...
Private Const pxeMODULENAME = "frmTardiness"

Private WithEvents oTrans As ggcTimekeeper.clsUndertime
