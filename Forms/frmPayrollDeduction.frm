...
Begin VB.Form frmPayrollDeduction 
   BorderStyle     =   0  'None
   Caption         =   "Deduction"
   ClientHeight    =   3090
   ClientLeft      =   0
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmPayrollDeduction.frx":0000
   End
   ...
   End
End
Attribute VB_Name = "frmPayrollDeduction"
...
Private Sub LoadDetail()
   ...
   With MSFlexGrid1
      ...
      Do Until p_oRS.EOF
         ...
         .TextMatrix(lnCtr + 1, 2) = Format(p_oRS("nBalancex"), "###,###.00")
         .TextMatrix(lnCtr + 1, 3) = Format(p_oRS("nAmountxx"), "###,###.00")
