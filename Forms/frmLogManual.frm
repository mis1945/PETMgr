...
Private Const pxBRANCHCODES = "M001»A001»N001»PHO1»PHO2"
...
Private Sub cmdDetail_Click(Index As Integer)
   ...
   If Not oTrans.hasReferNox Then GoTo endProc
...
'         MoveToLastRec
      ...
      Case 2
         If oTrans.loadEmployee Then
            ...
            txtOthers(6).Enabled = oTrans.IsActivePMOutxxx
         Else
            MSFlexGrid1.Rows = 3
         End If
         GoTo endWithFocus
   ...
   With txtField(Index)
      Select Case Index
         ...
         Case Else
            ...
            If Index = 3 Then
               InitOthers (IIf(oTrans.hasReferNox, 1, 0))
            End If
      End Select
   End With
End Sub
...
Private Sub txtField_Validate(Index As Integer, Cancel As Boolean)
   ...
   End With
'   If Index = 2 And Not Trim(txtField(Index)) = "" Then
'      Call InitOthers(1)
'   End If
End Sub
