...
Begin VB.Form frmPayrollReg 
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":000C
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":0786
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":0F00
   End
   ...
   Begin xrControl.xrFrame xrFrame2 
      ...
      Begin VB.Image Image2 
         Height          =   2355
         Left            =   60
         Picture         =   "frmPayrollReg.frx":167A
         Stretch         =   -1  'True
         Top             =   60
         Width           =   2835
      End
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":F316
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":FBF0
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   4
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":104CA
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   6
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":10C44
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   7
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":113BE
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   8
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":11C98
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   9
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPayrollReg.frx":12572
   End
End
Attribute VB_Name = "frmPayrollReg"
...
'         If MSFlexGrid1.TextMatrix(lnCtr, 18) = "" And CCur(MSFlexGrid1.TextMatrix(lnCtr, 16)) > 0 Then
   ...
   Case 9 'Sendmacro
      sendMacroPayrollValidation oTrans.Master("sEmpTypID"), oTrans.Master("dPeriodFr")
   End Select
...
'   On Error GoTo errProc
   ...
   'kalyptus - 2019.07.12 12:01pm
   'for removal of benefits that are previously paid before the actual posting of payroll
...
'            lnDailyPay = Round(IIf(oTrans.Master("sEmpTypID") = "T", oTrans.Detail(lnCtr, "nBasicSal") / (oTrans.Detail(lnCtr, "nAttendnc") + oTrans.Detail(lnCtr, "nAbsencex")), oTrans.Detail(lnCtr, "nBasicSal") / 13), 2)
            ...
            .TextMatrix(lnCtr + 1, 19) = poRecord("nReleaseB")
'         Next
            lnCtr = lnCtr + 1
            poRecord.MoveNext
         Loop
...
Private Sub LoadDetail()
   ...
   With poRecord
      ...
      .Fields.Append "nReleaseB", adCurrency, 30
      ...
      For lnCtr = 0 To oTrans.ItemCount - 1
         ...
         If oTrans.Master("sEmpTypID") = "T" Then
            If oTrans.Detail(lnCtr, "cDivision") = 3 And oTrans.Master("dPeriodFr") > CDate("2019-04-30") Then
         ...
         'kalyptus - 2019.07.12 12:06pm
         .Fields("nReleaseB") = getAlreadyRelease(oTrans.Detail(lnCtr, "sPayPerID"), oTrans.Detail(lnCtr, "sEmployID"))
      Next
   End With
   ...
   With flxGrd
     ...
     For lnItemCtr = 1 To flxGrd.Rows - 1
         If .TextMatrix(lnItemCtr, 18) = "00XX006" And CCur(.TextMatrix(lnItemCtr, 16)) > 0 And Trim(.TextMatrix(lnItemCtr, 17)) <> "" Then
            ...
            xlsheet.Range(XNetPayxx & (lnLineCtr)).Value = CCur(.TextMatrix(lnItemCtr, 16)) - CCur(.TextMatrix(lnItemCtr, 19))
...
Private Function ExportCNB(flxGrd As MSFlexGrid) As Boolean
Dim xl As New Excel.Application
   Dim xlsheet As Excel.Worksheet
   Dim xlwbook As Excel.Workbook
   ...
   With flxGrd
     For lnItemCtr = 1 To flxGrd.Rows - 1
         If .TextMatrix(lnItemCtr, 18) = "00XX003" And CCur(.TextMatrix(lnItemCtr, 16)) > 0 And Trim(.TextMatrix(lnItemCtr, 17)) <> "" Then
            lnLineCtr = lnLineCtr + 1
            'she 2020-10-02 modify for the template
...
'kalyptus - 2019.07.12 11:18am
'remove benefits that are previously paid before the actual posting of payroll
Private Function getAlreadyRelease(ByVal fsPeriodID As String, ByVal fsEmployID As String) As Currency
   Dim loRS As Recordset
   Dim lsSQL As String
   Dim lnTotal As Currency
   
   lsSQL = "SELECT a.sEmployID, a.nAmountxx" & _
          " FROM Payroll_Benefits a" & _
            " LEFT JOIN Benefit b ON a.sBeneftID = b.sBeneftID" & _
          " WHERE a.sPayPerID = " & strParm(fsPeriodID) & _
            " AND a.sEmployID = " & strParm(fsEmployID) & _
            " AND b.cNoInBank = '1'"
   ...
   Do Until loRS.EOF
      lnTotal = lnTotal + poMiscx.Paway(loRS("nAmountxx"))
   
      loRS.MoveNext
   Loop
   
   getAlreadyRelease = lnTotal
End Function
