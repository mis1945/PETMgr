...
Begin VB.Form frmLeaveAdjReg 
   BorderStyle     =   0  'None
   Caption         =   "Leave Credit Adjustment Reg"
   ClientHeight    =   7440
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8280
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmLeaveAdjReg.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveAdjReg.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveAdjReg.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveAdjReg.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveAdjReg.frx":1DE8
   End
   ...
   End
End
Attribute VB_Name = "frmLeaveAdjReg"
...
Private Const pxeModuleName = "frmLeaveAdjReg"
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   Case 2   'update
      ...
      If oTrans.Master("cTranStat") = xeStateCancelled Or _
         oTrans.Master("cTranStat") = xeStatePosted Or _
         oTrans.Master("cTranStat") = xeStateUnknown Then
...
Private Sub LoadMaster()
   ...
   With oTrans
      For Each loTxt In txtField
         ...
         Case 1
            loTxt.Text = strLongDate(.Master(loTxt.Index))
         Case 5
            loTxt = getValue(.Master(loTxt.Index))
         Case 80
            loTxt.Text = .Master(80)
         Case Else
            loTxt.Text = .Master(loTxt.Index)
         End Select
      Next
