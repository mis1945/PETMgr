...
Begin VB.Form frmServiceChargeApproval 
   BorderStyle     =   0  'None
   ...
   Begin xrGridEditor.GridEditor GridEditor1 
      ...
      GRIDLINESFIXED  =   2
      GRIDLINEWIDTH   =   1
      MOUSEICON       =   "frmServiceChargeApproval.frx":0000
      MOUSEPOINTER    =   0
      REDRAW          =   -1  'True
      RIGHTTOLEFT     =   0   'False
      ROWS            =   2
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmServiceChargeApproval.frx":001C
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmServiceChargeApproval.frx":0796
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmServiceChargeApproval.frx":0F10
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmServiceChargeApproval.frx":168A
   End
   ...
   End
End
Attribute VB_Name = "frmServiceChargeApproval"
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   With GridEditor1
      ...
      Case 1 'Browse
         ...
         End If
      Case 2 'Approve
         If txtField(0).Text <> "" And (oTrans.Master("cTranStat") <> "2" Or oTrans.Master("cTranStat") <> "3") Then
            If oTrans.PostTransaction(txtField(0).Text) = True Then
      ...
      Case 3 'DisApproved
         If txtField(0).Text <> "" Then
           If oTrans.CancelTransaction(txtField(0).Text) = True Then
               MsgBox "Transaction successfully Posted!!", vbInformation, "Notice"
               Call LoadData
            End If
         End If
      End Select
