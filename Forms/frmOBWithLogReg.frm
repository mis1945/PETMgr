...
Begin VB.Form frmOBWithLogReg 
   BorderStyle     =   0  'None
   Caption         =   "Official Business With Log Reg"
   ClientHeight    =   7695
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8280
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogReg.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogReg.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogReg.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogReg.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogReg.frx":1DE8
   End
   ...
   End
End
Attribute VB_Name = "frmOBWithLogReg"
...
Private Const pxeMODULENAME = "frmForgot2SwipeReg"

Private WithEvents oTrans As clsForgot2Swipe
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   Case 2   'update
      If txtField(0) = "" Then
         Exit Sub
      ElseIf oTrans.Master(17) = xeStateCancelled Or _
         oTrans.Master(17) = xeStateClosed Or _
         oTrans.Master(17) = xeStatePosted Then
...
Private Sub Form_Load()
   ...
   Set oTrans = New clsForgot2Swipe
...
Private Sub InitForm(ByVal fnEdit As Integer)
   ...
   lbShow = IIf(fnEdit = 0, False, True)
...
Private Sub LoadMaster()
   ...
   With oTrans
      For Each loTxt In txtField
         ...
         Case 4 To 9
            loTxt = Format(IFNull(.Master(loTxt.Index), ""), "HH:MM ampm")
         Case 10
            loTxt = Format(.Master(17), "MMMM DD, YYYY")
         Case 20
            loTxt = WhoIs(.Master(loTxt.Index), True)
         Case Else
...
Private Sub oTrans_MasterRetrieved(ByVal Index As Variant, ByVal Value As Variant)
   Select Case Index
      ...
      Case 4 To 9
         txtField(Index) = Format(IFNull(Value, ""), "HH:MM ampm")
      Case Else
...
Private Sub txtField_Validate(Index As Integer, Cancel As Boolean)
   With txtField(Index)
      Select Case Index
      Case 4 To 9
         oTrans.Master(Index) = getCTime(.Text)
      Case Else
