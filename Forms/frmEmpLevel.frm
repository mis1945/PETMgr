...
Option Explicit
Private Const pxeMODULENAME = "frmEmpLevel"
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Employee_Level", "sEmpLevID", False, oApp.Connection)) Then Exit Sub
