...
Option Explicit
Private Const pxeMODULENAME = "frmTitle"
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Title", "sTitleIDx", False, oApp.Connection)) Then Exit Sub
