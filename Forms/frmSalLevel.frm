...
Begin VB.Form frmSalLevel 
   BorderStyle     =   0  'None
   Caption         =   "Salary Levels"
   ClientHeight    =   2895
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6855
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSalLevel.frx":2CDC
      PicturePos      =   1
   End
End
Attribute VB_Name = "frmSalLevel"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const pxeMODULENAME = "frmSalLevel"
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Salary_Level", "sSalLvlID", False, oApp.Connection)) Then Exit Sub
   oDriver.FieldReference(0) = True
   oDriver.FieldValue(1) = ""
   'kalyptus - 2023.11.17 11:51am
   'Add the default Salary Matrix Group ID of the New Record
   oDriver.FieldValue(2) = pcSalGrpID
