...
Begin VB.Form frmPayrollBenefits 
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmPayrollBenifits.frx":0000
   End
   ...
   End
End
Attribute VB_Name = "frmPayrollBenefits"
...
Private Sub LoadDetail()
   ...
   With MSFlexGrid1
      ...
      Do Until p_oRS.EOF
         ...
         .TextMatrix(lnCtr + 1, 1) = p_oRS("sBeneftNm")
         .TextMatrix(lnCtr + 1, 2) = p_oRS("nAmountxx")
