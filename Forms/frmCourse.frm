...
Option Explicit
Private Const pxeMODULENAME = "frmCourse"""
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Course", "sCourseID", False, oApp.Connection)) Then Exit Sub
