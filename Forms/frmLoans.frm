...
Option Explicit
Private Const pxeMODULENAME = "frmLoans"
...
Private Sub oDriver_InitValue()
   ...
   If Not oDriver.SetValue(0, GetNextCode("Loans", "sLoanIDxx", False, oApp.Connection)) Then Exit Sub
