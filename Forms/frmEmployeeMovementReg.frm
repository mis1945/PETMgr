...
Begin VB.Form frmEmployeeMovementReg 
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmEmployeeMovementReg.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeMovementReg.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeMovementReg.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeMovementReg.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeMovementReg.frx":1DE8
   End
   ...
   Begin xrControl.xrFrame xrFrame2 
      ...
      Begin VB.ComboBox cmbField 
         ...
         Height          =   360
         Index           =   24
         ItemData        =   "frmEmployeeMovementReg.frx":2562
         Left            =   1620
         List            =   "frmEmployeeMovementReg.frx":2578
   ...
   End
End
Attribute VB_Name = "frmEmployeeMovementReg"
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   Case 0   'save
      If oTrans.SaveTransaction(True) Then
         ...
         If IsDate(oTrans.Master("dEffectve")) Then
            If MsgBox("Approve this movement now?", vbYesNo + vbInformation, "Confirm Approval") = vbYes Then
               If oTrans.CloseTransaction(oTrans.Master("sTransNox")) Then
                  MsgBox "Employee movement was approved successfully!", vbOKOnly + vbInformation, "Confirmed"
               Else
                  MsgBox "Approval of employee movement has failed!!!", vbInformation, "Notice"
               End If
            End If
         End If
         ClearFields
   ...
   Case 2   'update
      If txtField(0) = "" Then
         Exit Sub
      ElseIf oTrans.Master("cTranStat") = xeStateCancelled Or _
         oTrans.Master("cTranStat") = xeStatePosted Or _
         oTrans.Master("cTranStat") = 4 Then
...
Private Sub Form_Activate()
   ...
   If oTrans.Master("sTransNox") <> "" And txtField(0) = "" Then
      LoadMaster
   End If
...
Private Sub InitForm(ByVal lnStat As Integer)
   ...
   txtField(88).Enabled = Not lbShow
'80       txtField(89).Enabled = Not lbShow
...
'   txtField(12).Enabled = lbShow
   ...
   If lbShow Then txtField(80).SetFocus
End Sub
...
'140         txtField(89) = .Master(89)
      txtField(12) = strLongDate(.Master(12))
      ...
      If .Master("cTranStat") = "4" Then
         Label2.Caption = "APPLIED"
      Else
         Label2.Caption = TransStat(Val(.Master("cTranStat")))
      End If
   End With
End Sub
...
Sub LoadMovement(ByVal fsTransNox As String)
Call oTrans.OpenTransaction(fsTransNox)
'20   LoadMaster
'30   Form_Activate
End Sub
