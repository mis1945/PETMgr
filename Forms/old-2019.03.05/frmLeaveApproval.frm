...
Begin VB.Form frmLeaveApproval 
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveApproval.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveApproval.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveApproval.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLeaveApproval.frx":166E
   End
   ...
   End
End
Attribute VB_Name = "frmLeaveApproval"
...
Private Const pxeMODULENAME = "frmLeaveApproval"
...
Private Sub LoadMaster()
   ...
   With oTrans
      ...
      For lnCtr = 3 To 11
         ...
         Case 7
            txtField(lnCtr) = getValue(.Master(lnCtr))
         Case Else
            txtField(lnCtr) = IFNull(.Master(lnCtr))
         End Select
      Next
   End With
   txtSearch(0) = txtField(0)
   txtSearch(1) = txtField(80)
   txtField(12) = IIf(oTrans.DateApproved = "", "", strLongDate(oTrans.DateApproved))
...
Private Sub txtField_GotFocus(Index As Integer)
   ...
   Select Case Index
      ...
      Case 12
         txtField(Index) = strShortDate(oTrans.DateApproved)
   End Select
