...
Private Const pxeMODULENAME = "frmOTReg"
...
'      If oTrans.Master(0) <> "" Then
         ...
         If lnRep = vbYes Then
            ...
            clearFields
         End If
'         If oTrans.CancelTransaction(txtField(0).Text) Then
...
Private Sub LoadMaster()
   ...
   With oTrans
      For lnCtr = 0 To 5
         ...
         End Select
      Next
      If IsDate(.Master(7)) Then
         txtfield(7).Text = strLongDate(.Master(7))
      Else
         txtfield(7).Text = ""
      End If
   End With
...
Private Sub txtField_GotFocus(Index As Integer)
   ...
   Select Case Index
      Case 1, 3
         txtfield(Index).Text = strShortDate(oTrans.Master(Index))
   End Select
