...
Begin VB.Form frmOBWithLogApprvl 
   BorderStyle     =   0  'None
   Caption         =   "Official Business With Log Approval"
   ClientHeight    =   6585
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8280
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogApprvl.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogApprvl.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogApprvl.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmOBWithLogApprvl.frx":166E
   End
   ...
   End
End
Attribute VB_Name = "frmOBWithLogApprvl"
...
Private Const pxeMODULENAME = "frmForgot2Swipe"
...
Private Sub cmdButton_Click(Index As Integer)
   ...
   Case 2   'approve
      ...
      If oApp.ProductID = "PetMgr" Then
         lbResult = oTrans.PostTransaction(oTrans.Master(0))
      Else
         lbResult = oTrans.CloseTransaction(oTrans.Master(0))
      End If
      
      If lbResult Then
         Label2.Caption = TransStat(CInt(oTrans.Master(18)))
...
Private Sub txtField_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
   If Index = 2 Then
      Select Case KeyCode
      Case vbKeyReturn
         oTrans.Master(2) = txtfield(Index)
      Case vbKeyF3
