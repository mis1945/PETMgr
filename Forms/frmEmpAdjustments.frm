...
Begin VB.Form frmEmpAdjustments 
   BorderStyle     =   0  'None
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmpAdjustments.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmpAdjustments.frx":077A
   End
   ...
   End
End
Attribute VB_Name = "frmEmpAdjustments"
...
Private Const pxeMODULENAME = "frmEmpAdjustments"

Private oDriver As clsFormDriver
Private WithEvents oTrans As clsEmpAdjustment
...
Private Sub Form_Load()
   ...
   Set oTrans = New clsEmpAdjustment
...
Private Sub MSFlexGrid1_Click()
   ...
   For Each loTxt In txtField
      ...
      End Select
   Next
   Label2.Caption = TransStat(CInt(oTrans.Detail(lnRow, 9)))
...
Private Sub oTrans_DetailRetrieved(ByVal Row As Integer, ByVal Index As Variant)
   Select Case Index
   Case 1
      txtField(4) = IFNull(oTrans.Detail(Row, 4), "")
   End Select
End Sub
