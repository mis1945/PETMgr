...
Begin VB.Form frmEmployeeDeductionsReg 
   BorderStyle     =   0  'None
   Caption         =   "Employee Payroll  Deductions"
   ClientHeight    =   7575
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8280
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmEmployeeDeductionsReg.frx":0000
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   3
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeDeductionsReg.frx":077A
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeDeductionsReg.frx":0EF4
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeDeductionsReg.frx":166E
   End
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEmployeeDeductionsReg.frx":1DE8
   End
   ...
   End
End
Attribute VB_Name = "frmEmployeeDeductionsReg"
...
Private Const pxeMODULENAME = "frmEmployeeDeductionsReg"

Private oDriver As clsFormDriver
Private WithEvents oTrans As clsPayrollDeductions
...
Private Sub Form_Load()
   ...
   Set oTrans = New clsPayrollDeductions
