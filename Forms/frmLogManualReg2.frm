...
Begin VB.Form frmLogManualReg2 
   BorderStyle     =   0  'None
   Caption         =   "Log Manual"
   ClientHeight    =   9630
   ClientLeft      =   0
   ...
   Begin xrControl.xrButton cmdButton 
      ...
      EndProperty
      Picture         =   "frmLogManualReg2.frx":0000
   End
   Begin xrControl.xrButton cmdDetail 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLogManualReg2.frx":077A
   End
   Begin xrControl.xrButton cmdDetail 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLogManualReg2.frx":180C
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLogManualReg2.frx":1F86
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   5
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLogManualReg2.frx":2700
   End
   Begin xrControl.xrButton cmdButton 
      Height          =   600
      Index           =   0
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLogManualReg2.frx":2E7A
   End
   Begin xrControl.xrButton cmdButton 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLogManualReg2.frx":35F4
   End
   Begin xrControl.xrButton cmdDetail 
      Height          =   600
      Index           =   2
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmLogManualReg2.frx":3D6E
   End
   ...
   Begin xrControl.xrFrame xrFrame2 
      ...
      Begin xrControl.xrFrame xrFrame3 
         ...
         Begin VB.ComboBox cmbField 
            ...
            Height          =   390
            Index           =   7
            ItemData        =   "frmLogManualReg2.frx":44E8
            Left            =   7695
            List            =   "frmLogManualReg2.frx":44FB
   ...
   End
End
Attribute VB_Name = "frmLogManualReg2"
...
Private WithEvents oTrans As clsLogManual2
...
50       Select Case Index
      Case 0   'save
60             Call oTrans.DeleteDetail(oTrans.ItemCount)
70             If oTrans.SaveTransaction Then
80                MsgBox "Transaction was successfuly updated.", vbInformation, "Notice"
90                Call ClearFields
100               Call InitForm(0)
110               Call InitGrid
120               pbUpdateMode = False
130               GoTo endWithFocus
140            End If
150         Case 2   'update
160            If oTrans.UpdateTransaction Then
170               Call InitForm(1)
'            oTrans.AddDetail
            
            'Reposition Row
180               pnRow = oTrans.ItemCount - 1
190               pnActiveRow = pnRow + 1
            
200               With MSFlexGrid1
210                  .Row = 2
220                  pnActiveRow = 2
230                  .Col = 1
240                  .ColSel = .Cols - 1
250               End With
260               pbUpdateMode = True
270               GoTo endWithFocus
280            Else
290               MsgBox "Updating Closed/Cancelled/Posted Transaction is strictly prohibited!!!", vbCritical, "Warning"
300            End If
310         Case 3   'browse
...
410         Case 4   'cancel
420            lnRep = MsgBox("Transaction is in Update Mode!!!" & vbCrLf & _
                        "Do you want to Cancel Transaction!!!", vbYesNo + vbQuestion, "Confirm")
   
430            If lnRep = vbYes Then
440               Call ClearFields
450               Call InitForm(0)
460               Call InitGrid
470               pbUpdateMode = False
480               GoTo endWithFocus
490            End If
...
110      Set oTrans = New clsLogManual2
...
50       cmdButton(2).Visible = Not lbShow
60       cmdButton(5).Visible = Not lbShow

70       cmdButton(0).Visible = lbShow
80       cmdButton(4).Visible = lbShow
   
90       txtSearch(0).Enabled = Not lbShow
100      txtSearch(1).Enabled = Not lbShow
...
20       For lnCtr = 0 To 3
30          If lnCtr = 1 Then
40             If Len(oTrans.Master(7)) = 4 Then
50                txtField(lnCtr) = oTrans.Master(lnCtr)
60                txtField(1).Visible = True
70                cmbField(7).Visible = False
80                lblField(1) = "Branch Name"
90             Else
100               cmbField(7).ListIndex = oTrans.Master(7)
110               txtField(1).Visible = False
120               cmbField(7).Visible = True
130               lblField(1) = "Employee Level"
140            End If
150         Else
160            txtField(lnCtr) = oTrans.Master(lnCtr)
170         End If
180      Next
   
190      txtSearch(0) = txtField(0)
200      txtSearch(1) = txtField(3)
210      txtField(2) = Format(txtField(2), "MMMM DD, YYYY")

220      If oTrans.Master("cTranStat") = "4" Then
221         Label2.Caption = "APPLIED"
222      Else
223         Label2.Caption = TransStat(CInt(oTrans.Master("cTranStat")))
224      End If
...
30       If oTrans.ItemCount = 0 Then oTrans.InitTransaction
40       lnRow = oTrans.ItemCount

50       With MSFlexGrid1
60          .Rows = 3
70          .Rows = lnRow + 2
      
80          If MSFlexGrid1.Rows > 13 Then
90             .ColWidth(1) = 3050
100         Else
110            .ColWidth(1) = 3300
120         End If
      
130         For lnCtr = 0 To lnRow - 1
140            .TextMatrix(lnCtr + 2, 0) = lnCtr + 1
150            .TextMatrix(lnCtr + 2, 1) = IFNull(oTrans.Detail(lnCtr, 0), "")
160            .TextMatrix(lnCtr + 2, 2) = IFNull(oTrans.Detail(lnCtr, 1), "")
170            .TextMatrix(lnCtr + 2, 3) = IFNull(oTrans.Detail(lnCtr, 2), "")
180            .TextMatrix(lnCtr + 2, 4) = IFNull(oTrans.Detail(lnCtr, 3), "")
190            .TextMatrix(lnCtr + 2, 5) = IFNull(oTrans.Detail(lnCtr, 4), "")
200            .TextMatrix(lnCtr + 2, 6) = IFNull(oTrans.Detail(lnCtr, 5), "")
210            .TextMatrix(lnCtr + 2, 7) = IFNull(oTrans.Detail(lnCtr, 6), "")
220         Next
...
230         Call detailFieldChange 'set info into textbox
240      End With
